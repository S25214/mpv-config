...
mp.add_key_binding(nil, "mode-switch", function() mode_switch("cycle") end)
mp.add_key_binding(nil, "stop-cache-write", stop)
mp.add_key_binding(nil, "align-cache", align_cache)
mp.add_key_binding(nil, "cache-write",
